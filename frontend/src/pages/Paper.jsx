...
import { papersApi, notesApi, projectsApi, projectPapersApi } from '../services/api'
...
function LinkToProjectButton({ paperId, websiteId }) {
  ...
  async function handleLink(project) {
    ...
    try {
      ...
      // 409 or unique constraint = already linked
  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="flex items-center gap-1 px-2 py-1 rounded-lg text-slate-500 hover:text-blue-600 hover:bg-slate-100 transition-colors text-xs font-medium"
      >
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-2.5 border-b border-slate-200 bg-white">
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          <LinkToProjectButton paperId={paper.id} />
          <button
